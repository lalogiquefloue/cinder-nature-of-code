#ifndef CINDER_NATURE_OF_CODE_STEERED_WALKER_H
#define CINDER_NATURE_OF_CODE_STEERED_WALKER_H
...
public:
    ...
    SteeredWalker() : mWeights{0.25f, 0.25f, 0.25f, 0.25f}
    {
        pos.x = cinder::app::getWindowWidth() / 2.0f;
        pos.y = cinder::app::getWindowHeight() / 2.0f;
    };

    SteeredWalker(StepWeights probs) : mWeights(probs)
    {
        pos.x = cinder::app::getWindowWidth() / 2.0f;
        pos.y = cinder::app::getWindowHeight() / 2.0f;
    };
...
#endif //CINDER_NATURE_OF_CODE_STEERED_WALKER_H
